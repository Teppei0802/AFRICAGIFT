  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-6 md:py-12">
      <div className="flex flex-col md:flex-row gap-6 md:gap-12">
        ...
        <div className="md:w-1/2">
          <div className="sticky top-24">
            ...
            <div className="bg-white border-2 md:border-4 border-black rounded-xl p-4 md:p-6 shadow-[4px_4px_0_0_#000] md:shadow-[8px_8px_0_0_#000]">
              <h3 className="font-black text-lg md:text-xl mb-2 uppercase italic">About {team.name}</h3>
              <p className="text-xs md:text-base text-gray-700 leading-relaxed font-bold">{team.description}</p>
            </div>
          </div>
        </div>
        ...
        {/* 右側：入力フォーム */}
        <div className="md:w-1/2">
          <h1 className="pop-heading text-lg md:text-4xl mb-2">{team.name}</h1>
          ...
          <form className="space-y-3 md:space-y-8 text-left">
            ...
            <div className="pop-card p-3 md:p-6">
              ...
              <p className="text-[8px] md:text-xs text-gray-500 mb-1 md:mb-3 font-bold">パフォーマーが元気いっぱいに読み上げます（30文字程度推奨）</p>
              <textarea 
            ...
            <div className="pop-card p-3 md:p-6">
              ...
              <p className="text-[8px] md:text-xs text-gray-500 mb-1 md:mb-3 font-bold">動画内で掲げる黒板に記載します</p>
              <input 
                type="text" 
                className="w-full border-2 md:border-4 border-black rounded-lg p-2 md:p-3 text-xs md:text-base font-bold focus:outline-none focus:border-red-500 transition-colors" 
            ...
            <div className="pop-card p-3 md:p-6">
              ...
              <p className="text-[8px] md:text-xs text-gray-500 mb-1 md:mb-3 font-bold">完成した動画のダウンロードリンクをお送りします</p>
              <input 
                type="email" 
                className="w-full border-2 md:border-4 border-black rounded-lg p-2 md:p-3 text-xs md:text-base font-bold focus:outline-none focus:border-red-500 transition-colors" 
            ...
            <div className="pop-card p-3 md:p-6">
              ...
              <div className="space-y-2 md:space-y-4">
                <label className="flex items-center gap-2 md:gap-3 font-bold cursor-pointer p-2 md:p-3 border-2 border-gray-200 rounded-lg hover:border-black transition-colors has-[:checked]:border-black has-[:checked]:bg-yellow-100">
                  ...
                  />
                  <span className="text-[10px] md:text-base">おまかせ（踊りやすい音楽） <span className="text-gray-500">+¥0</span></span>
                </label>
                ...
                <label className="flex items-center gap-2 md:gap-3 font-bold cursor-pointer p-2 md:p-3 border-2 border-gray-200 rounded-lg hover:border-black transition-colors has-[:checked]:border-black has-[:checked]:bg-yellow-100">
                  <input 
                    ...
                    className="w-3 h-3 md:w-5 md:h-5 accent-black" 
                  />
                  <span className="text-[10px] md:text-base">音楽指定（YouTube等） <span className="text-red-500">+¥1,200</span></span>
                </label>
                {musicOption === 'youtube' && (
                  <input 
                    type="text" 
                ...
                <label className="flex items-center gap-2 md:gap-3 font-bold cursor-pointer p-2 md:p-3 border-2 border-gray-200 rounded-lg hover:border-black transition-colors has-[:checked]:border-black has-[:checked]:bg-yellow-100">
                  <input 
                    ...
                    className="w-3 h-3 md:w-5 md:h-5 accent-black" 
                  />
                  <span className="text-[10px] md:text-base">バースデーソング <span className="text-red-500">+¥500</span></span>
                </label>
              </div>
            </div>
            ...
            <div className="pop-card p-3 md:p-6">
              ...
              <div className="space-y-2 md:space-y-4">
                <label className="flex items-center gap-2 md:gap-3 font-bold cursor-pointer p-2 md:p-3 border-2 border-gray-200 rounded-lg hover:border-black transition-colors has-[:checked]:border-black has-[:checked]:bg-yellow-100">
                  ...
                  />
                  <span className="text-[10px] md:text-base">写真プリントアウト <span className="text-red-500">+¥1,000</span></span>
                </label>
                {photoPrint && (
                ...
                <label className="flex items-center gap-2 md:gap-3 font-bold cursor-pointer p-2 md:p-3 border-2 border-gray-200 rounded-lg hover:border-black transition-colors has-[:checked]:border-black has-[:checked]:bg-yellow-100">
                  <input 
                    ...
                    className="w-3 h-3 md:w-5 md:h-5 accent-black rounded" 
                  />
                  <span className="text-[10px] md:text-base">写真へのキス <span className="text-red-500">+¥200</span></span>
                </label>
              </div>
            </div>
            ...
            <div className="pop-card p-3 md:p-6">
              ...
              <p className="text-[8px] md:text-xs text-gray-500 mb-1 md:mb-3 font-bold">パフォーマーたちにケーキをプレゼントし、一緒に食べる様子を動画に収めます</p>
              <select 
                value={cakeOption}
            ...
            <div className="sticky bottom-4 z-40 bg-white border-2 md:border-4 border-black rounded-2xl p-3 md:p-6 shadow-[4px_4px_0_0_#ef4444] md:shadow-[8px_8px_0_0_#ef4444]">
              <div className="flex justify-between items-end mb-2 md:mb-4">
                <span className="font-black text-xs md:text-xl">合計金額 (税込)</span>
      ...
      <section className="mt-8 md:mt-24 text-left">
        <h2 className="pop-heading !text-sm md:!text-4xl mb-4 md:mb-12 text-center underline decoration-red-500 decoration-4 md:decoration-8 whitespace-nowrap">Customer Reviews</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
          {/* レビュー1 */}
          <div className="pop-card p-3 md:p-6">
            <div className="text-yellow-400 text-sm md:text-2xl mb-1 md:mb-2 tracking-widest">★★★★★</div>
            <h4 className="font-black text-[10px] md:text-lg mb-1 md:mb-2">最高の誕生日になりました！</h4>
            ...
            <div className="flex items-center gap-1 md:gap-2 border-t border-gray-100 pt-2 md:pt-4">
              ...
              <span className="text-[8px] md:text-xs font-bold text-gray-500">20代 女性 / {team.name} 利用</span>
            </div>
          </div>
          ...
          <div className="pop-card p-3 md:p-6">
            <div className="text-yellow-400 text-sm md:text-2xl mb-1 md:mb-2 tracking-widest">★★★★★</div>
            <h4 className="font-black text-[10px] md:text-lg mb-1 md:mb-2">クオリティが高すぎる</h4>
            <p className="text-[8px] md:text-sm text-gray-700 mb-2 md:mb-4 leading-tight md:leading-relaxed">
            ...
            <div className="flex items-center gap-1 md:gap-2 border-t border-gray-100 pt-2 md:pt-4">
              ...
              <span className="text-[8px] md:text-xs font-bold text-gray-500">30代 男性 / {team.name} 利用</span>
            </div>
          </div>
          ...
          <div className="pop-card p-3 md:p-6">
            <div className="text-yellow-400 text-sm md:text-2xl mb-1 md:mb-2 tracking-widest">★★★★★</div>
            <h4 className="font-black text-[10px] md:text-lg mb-1 md:mb-2">ケーキ寄付で笑顔の連鎖</h4>
            <p className="text-[8px] md:text-sm text-gray-700 mb-2 md:mb-4 leading-tight md:leading-relaxed">
            ...
            <div className="flex items-center gap-1 md:gap-2 border-t border-gray-100 pt-2 md:pt-4">
              ...
              <span className="text-[8px] md:text-xs font-bold text-gray-500">40代 女性 / {team.name} 利用</span>
            </div>
          </div>
        </div>
      </section>
